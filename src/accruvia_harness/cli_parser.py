...
def build_parser() -> argparse.ArgumentParser:
    ...
    sa_watch_loop = subparsers.add_parser("sa-watch-loop", help="Run the sa-watch continuity supervisor continuously.")
    ...
    supervise.add_argument("--sa-watch-interval-seconds", type=float, default=600.0)
    supervise.add_argument("--no-sa-watch-autostart", action="store_true")
    subparsers.add_parser("stop-supervisors", help="Request a graceful stop for running supervisors.")
    subparsers.add_parser("kill-supervisors", help="Force-kill running supervisors immediately.")
