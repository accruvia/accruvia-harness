...
def build_parser() -> argparse.ArgumentParser:
    ...
    doctor = subparsers.add_parser("doctor", help="Show operator-facing diagnostics for config, executors, and readiness.")
    doctor.add_argument("--json", action="store_true", help="Emit the raw structured doctor payload.")
