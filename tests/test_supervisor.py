...
class SupervisorServiceTests(unittest.TestCase):
    ...
    def test_supervisor_emits_progress_events(self) -> None:
        ...
        self.assertEqual("max_iterations_reached", result.exit_reason)
        self.assertEqual("heartbeat_running", events[0]["type"])
        self.assertEqual("heartbeat_succeeded", events[1]["type"])
        self.assertEqual("task_started", events[2]["type"])
        self.assertEqual("task_finished", events[3]["type"])
        self.assertEqual({"pending": 1}, events[3]["backlog_before"]["tasks_by_status"])
        self.assertEqual({"completed": 1}, events[3]["backlog_after"]["tasks_by_status"])
